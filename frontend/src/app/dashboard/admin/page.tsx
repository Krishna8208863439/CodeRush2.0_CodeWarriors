...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Top Banner */}
      <div className="bg-white p-6 rounded-lg border border-slate-300 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-l-4 border-l-purple-900">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-purple-900 uppercase tracking-wider mb-1">
            <ShieldCheck className="w-4 h-4 text-purple-900" /> Municipal Super Admin Governance Console
          </div>
          <h2 className="text-xl md:text-2xl font-extrabold text-slate-900">City-Wide Analytics, Heatmaps & SLA Violation Audits</h2>
          <p className="text-slate-600 text-xs md:text-sm mt-0.5">
            Cross-department performance metrics, city-wide GIS spatial heatmaps, SLA breach tracking, and SentenceTransformer duplicate consolidation ROI.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm space-y-1">
          ...
          <p className="text-[11px] text-slate-500">City Target Resolution Standard</p>
        </div>
        ...
        <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm space-y-1">
          ...
          <p className="text-[11px] text-slate-500">Multimodal AI Intake Total</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-lg border border-slate-300 shadow-sm space-y-4">
          <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider flex items-center gap-2">
            <Building2 className="w-4 h-4 text-blue-900" /> Municipal Department Workload Comparison
          </h3>
        ...
        <div className="bg-slate-900 text-white p-6 rounded-lg border border-slate-800 shadow-sm space-y-5 flex flex-col justify-between">
          ...
          <div className="pt-2 border-t border-slate-800 text-[11px] text-slate-400">
            Civic OS Admin Governance Service v2.0
          </div>
        </div>
      </div>
    </div>
